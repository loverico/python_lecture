...
from transformers.optimization import AdamW, get_linear_schedule_with_warmup#WarmupLinearSchedule
...
def main():
    ...
    tokenizer = BertJapaneseTokenizer.from_pretrained(args.bert_model, do_lower_case=False,
                                              tokenize_chinese_chars=False)
